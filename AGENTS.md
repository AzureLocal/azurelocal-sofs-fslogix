# azurelocal-sofs-fslogix — Agent instructions
...
ARM template repo for Azure infrastructure deployments. Templates target Azure Local and related services and follow HCS IaC governance standards.
...
```
bootstrap(repo="azurelocal-sofs-fslogix", client="<your client: claude-code | codex | gemini | cursor | vscode>")
```
